            ...
            <div class="myform form ">
               <form action="Login" method="post" name="Login">
                  ...
                  <div class="text-center ">
                     <button type="submit" class=" btn btn-block send-button tx-tfm" name="Login">Log in</button>
                  </div>
                  <div class="col-md-12 ">
                     <div class="login-or">
                        <hr class="hr-or">
                  ...
                  <div class="form-group">
                     <a class="btn btn-block g-button" onclick="location.href='signup.jsp'"> Sign up 
                     </a>
                  </div>
                  <p class="small mt-3">Sign up to create account for free!
                  </p>
               </form>
